...
$comlist[]='
{
	...
	"commands":[
		{"TYPE":"INSERT","FROM":"rmn_exp ex","FIELDS":[{"txtdata":"?"},{"intdata":"?"}],
			"LINK":[{"DATA":"txt1000"},{"DATA":"1000"}]},
		{"TYPE":"INSERT","FROM":"rmn_exp ex","FIELDS":[{"txtdata":"?"},{"intdata":"?"}],
			"LINK":[{"DATA":"txt1001"},{"DATA":"1001"}]},
		{"TYPE":"SELECT","FROM":"rmn_exp ex","FIELDS":[{"txtinf":"txtdata"},{"intinf":"intdata"}],
			"WHERE":["intdata=?"],"LINK":[{"DATA":"1000"}]},
		{"TYPE":"UPDATE","FROM":"rmn_exp ex","FIELDS":[{"txtdata":"?"}],"WHERE":["intdata=?"],
...
$comlist[]='
{
	...
	"commands":[
		{"TYPE":"INSERT","FROM":"rmn_exp ex","FIELDS":[{"intdata":"?"},{"txtdata":"?"},{"blobdata":"?"}],
			"LINK":[{"DATA":"1005"},{"DATA":"blob text1"},{"DATA":"text1.txt","ISFILE":true}]},
		{"TYPE":"SELECT","FROM":"rmn_exp ex","FIELDS":[{"txtinf":"txtdata"},{"blobinf":"blobdata"}],
			"WHERE":["intdata=?"],"LINK":[{"DATA":"1005"}]},
		{"TYPE":"UPDATE","FROM":"rmn_exp ex","FIELDS":[{"txtdata":"?"},{"blobdata":"?"}],"WHERE":["intdata=?"],
...
$comlist[]='
{
	...
	"commands":[
		...
		{"TYPE":"SELECT","FROM":"rmn_exp ex","FIELDS":[{"txtinf":"txtdata"}],"WHERE":["intdata=?"],
			"LINK":[{"DATA":"1006"}]},
		{"TYPE":"UPDATE","FROM":"rmn_exp ex","FIELDS":[{"txtdata":"?"}],"WHERE":["intdata=?"],
...
$comlist[]='
{
	...
	"commands":[
		{"TYPE":"INSERT","FROM":"rmn_insel ex","FIELDS":[{"id":"?"},{"intdata":"?"},{"txtinfo":"?"},{"justtxt":"?"}],
		...
		{"TYPE":"SELECT","FROM":"rmn_exp ex","FIELDS":[
			{"TYPE":"SELECT","FROM":"rmn_insel inex","FIELDS":[{"idd":"id"},{"info":"txtinfo"},{"just":"justtxt"}],
